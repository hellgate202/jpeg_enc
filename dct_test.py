...
def dct_1d( img ):
  ...
  z[3] = c[3] * ( img[0] - img[7] ) - c[7] * ( img[1] - img[6] ) - c[1] * ( img[2] - img[5] ) - c[5] * ( img[3] - img[4] )
  print( c[3], ( img[0] - img[7] ), c[7], ( img[1] - img[6] ), c[1], ( img[2] - img[5] ), c[5], ( img[3] - img[4] ))
...
print( dct_1d_img[0] )
print( dct( img[0], type=2, norm='ortho' ) )
